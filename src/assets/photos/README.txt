Drop photos in this folder using these exact file names and they appear on the site
automatically (resized and converted to fast AVIF/WebP). JPG, PNG or WebP all work.
...
"Now on the Shelf" items can each have their own photo: add the file here and put its
name in the "photo" field in src/data/now-on-the-shelf.json.
